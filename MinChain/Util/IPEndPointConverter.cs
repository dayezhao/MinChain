    ...
    public class IPEndPointConverter : JsonConverter
    {
            ...
            JsonSerializer serializer)
        {
            ...
            if (ipEndPoint.IsNull())
                ...
                writer.WriteValue($"{ipEndPoint.Address}:{ipEndPoint.Port}");
        }
            ...
            JsonSerializer serializer)
        {
            ...
            return new IPEndPoint(Resolve(array[0]), int.Parse(array[1]));
        }

        static IPAddress Resolve(string hostNameOrAddress)
        {
            return IPAddress.TryParse(hostNameOrAddress, out var addr)
                ? addr
